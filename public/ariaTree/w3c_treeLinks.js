...
TreeLinks.prototype.init = function () {
  ...
  function findTreeitems (node, tree, group) {
    ...
    while (elem) {
      ...
      // I added <p> child case -- DMA
      if ( ( elem.tagName.toLowerCase() === 'li' && (elem.firstElementChild.tagName.toLowerCase() === 'p' || elem.firstElementChild.tagName.toLowerCase() === 'span') ) || elem.tagName.toLowerCase() === 'a') {
